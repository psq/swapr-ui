    ...
    return (
      <Autocomplete
        ...
        onChange={(event, newValue, kind) => {
          ...
          history.replace(`pool#${newValue}$${value_y}`)
    ...
    return (
      <Autocomplete
        ...
        onChange={(event, newValue, kind) => {
          ...
          history.replace(`pool#${value_x}$${newValue}`)
    ...
    <div className="Pairs">
      ...
      <div className="sp-form" id="swapForm" style={{display: 'block'}}>
        <div className="sp-form-tabs">
          <button className="sp-form-tab" onClick={() => { console.log("click"); history.push(value_x && value_y ? `/swap#${value_x}$${value_y}` : `/swap`)}}>Swap</button>
          <button className="sp-form-tab sp-form-tab--active" id="spPoolTab">Pool</button>
        </div>
